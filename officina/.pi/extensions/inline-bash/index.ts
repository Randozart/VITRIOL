// inline-bash — vendored 2026-08-31 from @earendil-works/pi-coding-agent 0.83.0
// examples/extensions/inline-bash.ts (MIT), verbatim except this header.
// Expands !{cmd} inside prompts before send (whole-line !cmd still passthrough).
// Kill switch: OFFICINA_NO_INLINE_BASH=1.
...
export default function (pi: ExtensionAPI) {
	if (process.env.OFFICINA_NO_INLINE_BASH === "1") return; // Rule 15
