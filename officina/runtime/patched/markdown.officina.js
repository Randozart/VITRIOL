...
// Source: @earendil-works/pi-tui 0.83.0 (MIT)
//         dist/components/markdown.js
// Modification (2026-08-31, owner request): strip the literal '#' prefix on
// level >= 3 headings — upstream keeps "### " visibly (styled) on h3+,
// which read as broken markdown in the officina TUI. Heading styling
// (bold/color) is unchanged.
    ...
    renderToken(token, width, nextTokenType, styleContext) {
        ...
        switch (token.type) {
            case "heading": {
                ...
                const styledHeading = headingStyleFn(headingText); // [officina] prefix stripped
